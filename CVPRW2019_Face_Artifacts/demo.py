...
path_shape_predictor = pwd + 'dlib_model/shape_predictor_68_face_landmarks.dat'
print('*************'+path_shape_predictor+'****************')
lmark_predictor = dlib.shape_predictor(path_shape_predictor)
